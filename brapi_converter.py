...
class BrapiToIsaConverter:
        ...
        for item in germplasm.keys():
            ...
            if item in valid_categories:
                if item == "subtaxa":
                    ...
                    these_characteristics.append(self.create_isa_characteristic(str(miameitem), str(germplasm[item])))
                ...
                if item == "accessionNumber":
                    ...
                    these_characteristics.append(self.create_isa_characteristic(str(item), str(germplasm[item])))
    ...
    def create_isa_characteristic(self, category, value):
